...
PROFILING_ENABLED: bool = asbool(os.environ.get("DD_PYTORCH_PROFILING", False))
STEP_OPTIMIZER_NAME: Optional[str] = os.environ.get("DD_PYTORCH_STEP_OPTIMIZER") or None
...
def _close_step(skipped: bool = False) -> None:
    ...
    if skipped:
        ...
        span.set_metric("step", _step_counter)
    span.finish()
    _STEP_TLS.span = None
