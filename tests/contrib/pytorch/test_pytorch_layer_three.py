...
# ---------------------------------------------------------------------------
# Task 4: only designated optimizer drives prof.step + ring buffer append
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Task 6: on_trace_ready - drop-on-miss + re-entry safety
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Task 7: clock alignment + periodic refresh
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Task 8: kernel span emission with full tag/metric set
# ---------------------------------------------------------------------------
...
def test_emit_kernel_span_tags_and_metrics(monkeypatch):
    ...
    class FakeTracer:
        def start_span(self, name, child_of=None, activate=False):
            captured["name"] = name
    ...
    # job_id is inherited via parent Context, not set explicitly.
    assert "job_id" not in span.tags


# ---------------------------------------------------------------------------
# Task 9: AMP-skip regression guard
# ---------------------------------------------------------------------------
